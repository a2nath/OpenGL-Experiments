...
void EquilizeImage::cumhist(int histogram[], int cumhistogram[])
{
...
void EquilizeImage::histDisplay(int histogram[], const char* name)
{
	int hist[256];
	for (int i = 0; i < 256; i++)
	{
...
void EquilizeImage::imhist(Mat image, int histogram[])
{
...
EquilizeImage::EquilizeImage(std::string imagename)
{
	Mat image = imread("Texures\\" + imagename + ".ppm", CV_LOAD_IMAGE_GRAYSCALE);
